...
import com.sky.constant.HttpStatus;
import com.sky.minio.MinioConfig;
import io.minio.*;
...
public class MinioUtils {
     ...
     * @param name 名字
     * @return boolean
     * @Description description: 判断bucket是否存在，不存在则创
     */
    ...
    public void upload(MultipartFile file, String fileName) {
        // 首先判断桶是否存在
        boolean existBucket = existBucket(configuration.getBucketName());
        if (existBucket){
